		...
		<div className="relative :bg-red-300">
			...
			<div className="relative bg-getlinkedai_bg">
				...
				<div className="relative text-center mx-auto pt-8 bg-red-20 lg:pt-0">
					...
					<div className="relative w-full bg-red-20">
						...
						<div className="absolute right-[15%] top-6 w-24 lg:w-40 lg:top-9 lg:right-14">
				...
				{/* getlinked Tech */}
					<div className="relative w-[90%] mx-auto mt-14 text-center bg-red-20 lg:w-[60%] lg:text-left lg:pl-28 lg:mt-32">
						<div className="relative bg-red-20">
							<div className="relative w-72 mx-auto bg-red-40 lg:w-full">
								...
								<div className="lg:absolute lg:w-10 lg:h-14 lg:right-[10%] lg:-top-12 bg-red-30 ">
									<div className="absolute w-5 h-6 -top-2 right-9 bg-red-20 lg:w-10 lg:h-12 lg:-left-[5.5rem] lg:top-2">
						...
						<div className="text-center text-gray-50 text-[.95rem] font-medium font-serif space-y-1 mt-2">
							<div className="lg:hidden">
				...
				<div className="w-[80%] mx-auto text-center py-16 bg-red-30 lg:flex lg:justify-between">
					...
					<div className="relative text-center mt-7 lg:w-[50%] lg:mt-20">
						...
						<p className="text-getlinkedai_fuchsia font-semibold text-xl lg:text-left lg:text-3xl lg:font-extrabold">techHackathon 1.0</p>
							<p className="text-gray-50  font-normal leading-7 lg:text-left lg:text-lg lg:font-semibold">
				...
				<div className="bg-red-30 relative">
					...
					<div className="relative z-10 w-[80%] mx-auto text-center py-16 bg-red-30 lg:flex lg:flex-row-reverse lg:justify-between lg:pt-16 lg:pb-12">
						...
						<div className="relative text-center mt-3 lg:w-[50%] lg:mt-16">
							...
							<p className="text-getlinkedai_fuchsia font-semibold text-xl lg:text-left lg:text-3xl lg:font-extrabold">Guidelines</p>
							<div className="relative w-full bg-red-30">
								<p className="text-gray-50  font-normal leading-7 lg:text-left lg:text-xl lg:font-semibold">
									Our tech hackathon is a melting pot of visionaries, and its purpose is as clear as 
									day: to shape the future. Whether you're a coding genius, a design maverick, or a 
									concept wizard, you'll have the chance to transform your ideas into reality. Solving 
									real-world problems, pushing the boundaries of technology, and creating solutions 
				...
				<div className="relative bg-red-30">
					...
					<div className="relative w-[80%] mx-auto text-center py-16 bg-red-20 lg:flex">
						...
						<div className="relative text-center mt-3 lg:w-[60%] bg-red-40">
							...
							<p className="text-getlinkedai_fuchsia font-semibold text-xl lg:text-3xl lg:font-extrabold lg:text-left">Key attributes</p>
							<div className="relative w-full bg-red-30 mt-5 space-y-5">
								...
								<div className="w-full bg-red-40 lg:float-left">
									<div className="relative w-2/3 mx-auto text-center bg-red-20 lg:w-1/3 lg:mx-0">
										<button className="w-2/3 h-10 rounded-lg  bg-gradient-to-r from-pink-500 to-getlinkedai_light_purple text-gray-50 font-medium lg:w-full">Read More</button>
									</div>
								</div>
							</div>
					...
					<div className="relative w-[80%] mx-auto text-center py-10 bg-red-30 lg:flex lg:justify-between">
						<div className="lg:w-2/5 bg-red-20 lg:mt-16">
							<div>
								...
								<p className="text-getlinkedai_fuchsia font-semibold text-xl lg:text-left lg:text-3xl lg:font-extrabold">Question</p>
								<p className="text-gray-50 leading-7 mt-3 font-medium text-[.9rem] lg:text-left">We got answers to the questions that you might want to ask about getlinked Hackathon 1.0</p>
							</div>
				...
				<div className="relative w-full bg-getlinkedai_bg ">
					<div  className="relative w-[80%] mx-auto text-center py-10 bg-red-30">
						<div className="space-y-3 bg-red-20 lg:w-[50%] lg:mx-auto">
							...
							<p className="text-gray-100 font-medium text-[.9rem] ml-1 leading-7 lg:text-xl">Here is the breakdown of the time we anticipate using for the upcoming events.</p>
						</div>
								...
								<div className="bg-blue-40 relative w-[30%] h-[90%] bg-[rgba(212,52,254,0.12)] border-2 border-getlinkedai_fuchsia rounded lg:h-52">
									<div className="relative ">
										<div className="absolute text-center w-full -top-12 left-0 bg-red-20 lg:w-44 lg:-top-20 lg:left-2">
											...
											<div className="mt-1 text-[.9rem] flex flex-col justify-center text-gray-50 font-medium lg:text-xl">
												<p>2nd</p>
												<p>Runner</p>
					...
					<div className="relative w-[80%] mx-auto text-center pt-16 pb-48 bg-red-30 lg:flex">
						<div className="lg:w-[50%]">
							<div className="relative lg:text-left">
								...
								<p className="text-gray-50 leading-6 mt-7 font-sans text-[.9rem] font-medium">
										...
										<div className="space-y-6 mt-8">
											...
											<ul className="space-y-5">
												<li className="flex gap-1 lg:justify-start lg:gap-3">
													...
													<p className="text-left text-gray-50 font-medium leading-6 text-[.9rem] lg:mt-1">
											...
											<div className="relative w-2/3 mx-auto text-center bg-red-20">
												<button className="w-2/3 h-10 rounded-md  bg-gradient-to-r from-pink-500 to-getlinkedai_light_purple text-gray-50 font-medium">Read More</button>
											</div>
										</div>
									</div>
								</div>
				...
				<div className="relative bg-[rgba(16,11,32,1)] lg:pb-14">
					...
					<div className="relative w-[80%] mx-auto text-left pt-10 pb-14 bg-red-30 lg:flex lg:flex-wrap lg:justify-between lg:pb-0">
						<div className="lg:w-[40%] bg-blue-20">
							...
							<p className="text-gray-50 text-[.9rem] font-medium mt-5 lg:text-[1rem] lg:font-normal lg:mt-3">
							...
							<div className="flex gap-3 bg-red-30 w-[80%] my-10 text-[.9rem] lg:mt-20 lg:my-0">
								<p className="text-gray-50 font-semibold">Terms of Use</p>
								<div className="w-[1%] bg-getlinkedai_fuchsia"></div>
								<p className="text-gray-50 font-medium">Privacy Policy</p>
							</div>
						</div>
						...
						<div className="relative lg:w-[50%] lg:flex lg:justify-between bg-yellow-20 lg:mt-[3%]">
							<div className=" bg-red-20 lg:bottom-0 lg:w-56">
								<div className="space-y-3 lg:w-full bg-red-20">
									...
									<p className="text-white font-semibold text-base">Timeline</p>
									<p className="text-white font-semibold text-base">FAQs</p>
									<p className="text-white font-semibold text-base">Register</p>
								...
								<div className="relative mt-20 bg-red-40 lg:w-full lg:mt-0">
									...
									<ul className="space-y-4 mt-2">
										<li className="flex gap-5">
											...
											<p className="text-left text-white font-semibold text-[.9rem]">+234  6707653444</p>
										</li>
										<li className="flex gap-5">
											<div className="w-4 h-4 mt-1">
												<img src={location} className="w-full h-full" />
											</div>
											<div className="text-left text-white font-semibold text-[.9rem]">
												<p>27, Alara Street</p>
												<p>Yaba 100012</p>
												<p>Lagos State</p>
											</div>
						...
						<p className="text-gray-50 font-sm text-center mt-16 font-semibold text-sm lg:w-full lg:text-xl">All rights reserved. © getlinked Ltd.</p>
