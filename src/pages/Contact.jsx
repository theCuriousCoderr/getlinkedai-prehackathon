            ...
            <div className="float-left bg-red-20">
                <div className="bg-gradient-to-t from-pink-500 to-getlinkedai_light_purple w-7 h-7 md:w-10 md:h-10 p-[2px] rounded-full flex justify-center align-middle">
                    <div className="bg-getlinkedai_bg w-full h-full flex pt-[8px] md:pt-3 pr-[2px] justify-center rounded-full" >
                        <img src={back_arrow} className="w-[.5rem] h-[.5rem] md:w-3 md:h-3 " />
                    </div>
                </div>
            </div>
        </NavLink>
        ...
        <div className='z-30 md:w-[70%] md:mx-auto relative lg:flex lg:mt-14 lg:pb-28'>
            <div className='lg:w-[40%]'>
                <div className='lg:hidden'>
                    ...
                    <p className='text-sm md:text-lg text-white font-normal my-5'>Email us below to any question related to our event</p>
                </div>
            ...
            <div className='relative lg:w-[45%] lg:bg-[rgba(255,255,255,0.03)] lg:p-16 lg:h-[75vh] '>
                <div className=''>
                    ...
                    <form onSubmit={handleSubmit} className='space-y-8 mt-8 lg:mt-0 bg-red-20'>
                        <div>
                            <input required type="email" name="email" value={contactData.email} onChange={handleChange} placeholder="Email" className='text-lg w-full bg-[rgba(255,255,255,0.03)] border border-white rounded h-10 md:h-16 md:text-2xl px-6 py-6 font-normal text-gray-50 placeholder:text-slate-500 placeholder:text-lg md:placeholder:text-xl' />
                        </div>
                        <div>
                            <input required type="text" name="first_name" value={contactData.first_name} onChange={handleChange} placeholder="Team's name" className='text-lg w-full bg-[rgba(255,255,255,0.03)] border border-white rounded h-10 md:h-16 md:text-2xl px-6 py-6 font-normal text-gray-50 placeholder:text-slate-500 placeholder:text-lg md:placeholder:text-xl' />
                        </div>
                        <div>
                            <textarea required type="text" name="message" value={contactData.message} onChange={handleChange} placeholder="Message" className='text-lg w-full bg-[rgba(255,255,255,0.03)] border border-white rounded h-40 md:text-2xl lg:h-28 px-6 pt-3 font-normal text-gray-50 placeholder:text-slate-500 placeholder:text-lg md:placeholder:text-xl' />
                        </div>
                    ...
                    <div className='text-center mt-10 md:mt-14 lg:hidden'>
                        <p className='text-getlinkedai_fuchsia font-normal text-sm md:text-xl'>Share on</p>
